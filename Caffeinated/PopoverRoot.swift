...
/// MenuBarExtra `.window` panels keep the first layout size unless we
/// resize them. Grow/shrink from the top so the panel stays under the
/// status item when Settings expands.
